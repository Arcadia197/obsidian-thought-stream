...
export const VIEW_TYPE_GHOST_READER = 'ghost-reader-view';

export class GhostReaderView extends ItemView {
	...
	constructor(leaf: WorkspaceLeaf, plugin: WhisperBuddy) {
		super(leaf);
		this.plugin = plugin;
	}
	...
	getViewType() {
		return VIEW_TYPE_GHOST_READER;
	}

	getDisplayText() {
		return 'Ghost-Reader View';
	}
